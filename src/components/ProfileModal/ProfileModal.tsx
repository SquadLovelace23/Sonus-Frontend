                    ...
                    <>
                        <div className={`profile-modal ${isElementHidden ? 'hidden-modal' : 'visible-modal'}`}>
                            <NavLink to={`/profile/${currentUser ? currentUser.name : ''}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user-square-rounded" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
