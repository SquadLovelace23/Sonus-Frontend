    ...
    return (
        <>
            ...
            <section className="library-action-container">
                <article className={`playlist-modal ${isElementHidden ? 'playlist-hidden-modal' : 'playlist-visible-modal'}`}>
                    <div style={{ backgroundImage: `url(${imgSrc})`}} className="modal-song-thumbnail" />
                    ...
                    <form className="modal-form">
                        <input className="modal-input" type="text" placeholder={t('Name...')} autoComplete="off" 
                            name="name"
                            value={playlist?.name || ''}
                ...
                <article className="library-action-wrapper">
                    <svg onClick={toggleElement} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-square-rounded-plus" width="32" height="32" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
